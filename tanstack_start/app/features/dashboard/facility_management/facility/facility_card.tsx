    ...
    <Card>
      {facility.isSuccess && !facility.data && (
        <div className="px-4 py-6 sm:px-6 text-center space-y-4">
          ...
          <FacilityFormModalButton className="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
      ...
      {facility.isSuccess && facility.data && (
        <>
          <div className="px-4 py-6 space-y-4 sm:px-6 sm:flex sm:items-center sm:justify-between">
            ...
            <FacilityFormModalButton className="bg-blue-600 rounded text-white py-2 px-4 w-fit">
              Edit Facility
            </FacilityFormModalButton>
          </div>
